...
const investorSchema = [
    ...
    { name: 'startupStagePreference', label: 'Startup Stage Preference', type: 'text' },
    { name: 'investmentAmountRange', label: 'Investment Amount Range', type: 'text' },
    { name: 'geographicalPreference', label: 'Geographical Preference', type: 'text' },
...
export { adminSchema, authSchema, investorSchema, entrepreneurSchema, companyProfile, videoImage, businessDocuments };
